...
- **1.1 Functionality (8 pts): 8 / 8**  
  - Full automated suite currently passes: `python run_tests.py` -> **75 tests, 0 failures**.  
...
- [x] Keep automated validation green (`75/75`) after each substantive gameplay/system change.  
