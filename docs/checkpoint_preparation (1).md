...
Ask an agent to review your code against the Code Elegance Rubric (see [AGENTS.md](../AGENTS.md) or course site for link). Request that the review include:
...
Ask an agent to review your module against the Module Rubric (see course project page for link). Request the review include:
